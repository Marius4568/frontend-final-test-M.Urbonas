...
let formSteps = "";
_formStepsHtml.getSteps().then((data)=>{
    formSteps = data;
    updateForm();
...
function updateForm() {
    function update() {
        ...
        _gsapAnimations.progressBarChange(20 * currentStep);
        if (formSteps[currentStep].includes("Error") || formSteps[currentStep].includes("Empty")) document.querySelector("button[type='submit']").remove();
        else currentStep++;
    }
    ...
    switch(currentStep + 1){
        ...
        case 3:
            ...
            break;
        case 4:
            if (document.querySelector(".oops-btn")) document.querySelector(".oops-btn").remove();
...
async function fetchPersonData(id) {
    let step3 = ``;
    const personData = await _asyncFunctions.asyncFunctions.getData(`http://18.193.250.181:1337/api/people?&filters[id]=${id}`);
    if (personData.error) step3 = `Error ${personData.error.status}: ${personData.error.message}`;
    else if (personData.data.length < 1) step3 = `Empty array, no data found.`;
    else {
...
},{"./asyncFunctions":"kjQ1G","./localStorageFunctions":"4XBTr","./formStepsHtml":"lsqtn","./gsapAnimations":"fsgPo"}],"kjQ1G":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "asyncFunctions", ()=>asyncFunctions
);
parcelHelpers.export(exports, "dashboardAsyncFunctions", ()=>dashboardAsyncFunctions
);
...
const dashboardAsyncFunctions = {
    getAllPeopleFromDB: async function() {
        try {
            ...
            for(let page = 1; array.length < data.meta.pagination.total; page++){
                const data = await asyncFunctions.getData(`http://18.193.250.181:1337/api/people?&pagination[pageSize]=100&pagination[page]=${page}&populate=*`);
    ...
    updateSignupCountries: async function() {
        ...
        array.forEach((el)=>{
            ...
            if (shortcut) {
                if (!uniqueCountries.includes(shortcut.attributes.country)) uniqueCountries.push(shortcut.attributes.country);
            }
        });
    ...
    fillSelectCountryElem: async function(selectElem) {
        ...
        if (countries.error) console.log(`Error ${countries.error.status}: ${countries.error.message}. Couldn't load countries`);
        else if (countries.data.length < 1) alert(`Empty array, no country data found.`);
        else countries.data.forEach((el)=>{
...
},{}],"4XBTr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "localStorageFunctions", ()=>localStorageFunctions
);
const localStorageFunctions = {
    removeLocalStorageCheckboxes () {
        if (localStorage.getItem("activitiesAfterWork")) localStorage.removeItem("activitiesAfterWork");
    },
    ...
    getLocalStorageCheckboxes () {
        if (localStorage.getItem("activitiesAfterWork")) return JSON.parse(localStorage.getItem("activitiesAfterWork"));
    }
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lsqtn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getSteps", ()=>getSteps
);
var _asyncFunctions = require("./asyncFunctions");
let step1 = ``;
let step2 = ``;
...
async function getSteps() {
    ...
    try {
        ...
        if (activities.error) step1 = `Error ${activities.error.status}: ${activities.error.message}`;
        else if (activities.data.length < 1) step1 = `Empty array, no data found.`;
        else {
...
${activityCheckboxes}
        ...
        if (countries.error) step2 = `Error ${countries.error.status}: ${countries.error.message}`;
        else if (countries.data.length < 1) step2 = `Empty array, no data found.`;
        else {
...
},{"./asyncFunctions":"kjQ1G","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fsgPo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "progressBarChange", ()=>progressBarChange
);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
function progressBarChange(percent) {
    _gsapDefault.default.to(".progress-bar", {
        width: `${percent}%`
    });
}
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l4AUa","ebWYT"], "ebWYT", "parcelRequire6f59")
